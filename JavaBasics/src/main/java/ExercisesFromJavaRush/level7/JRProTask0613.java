...
выводом информации о самом крупном городе мира использовались статические переменные класса вместо локальных аргументов
метода.
...
public class JRProTask0613 {
    ...
    public static void printCityPopulation(String city, double population){
        ...
        System.out.println("В то время как в самом густонаселенном городе " + JRProTask0613.city + " население составляет " + JRProTask0613.population + " млн человек.");
    }
}
